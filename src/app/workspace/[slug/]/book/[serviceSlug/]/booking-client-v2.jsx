...
import { getAvailableSlots, submitBooking } from "../../../../booking-actions";
import {
    Clock,
    MapPin,
...
export default function BookingClientV2({ workspace, service }) {
    ...
    if (success) {
        return (
            <div className="bg-white border border-slate-100 rounded-[40px] p-12 text-center space-y-8 animate-luxury-in">
                ...
                <div className="bg-slate-900 rounded-[32px] p-8 text-white space-y-8 sticky top-24">
                    ...
                    {selectedTime && (
                        <div className="pt-6 border-t border-white/10 space-y-1">
                            ...
                            <p className="text-sm font-bold">{selectedTime.toLocaleDateString([], { weekday: 'long', month: 'long', day: 'numeric' })}</p>
                            <p className="text-lg font-black">{selectedTime.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</p>
                        </div>
                    )}
                </div>
            </div>
                                        ...
                                        {availableSlots.map((slot, i) => (
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    selectedTime && new Date(selectedTime).getTime() === new Date(slot).getTime()
                    ...
                    <div className="space-y-10 animate-luxury-in">
                        ...
                        <div className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <input
                                    className="w-full h-16 px-6 bg-slate-50 border border-slate-100 rounded-2xl text-base font-bold focus:bg-white focus:border-slate-900 outline-none transition-all"
